 ...
 *   --config <path>        混合流水线 JSON 配置文件，默认 configs/CloudnetHybridPipeline.json
...
int main(int argc, char** argv) {
    try {
        ...
        std::filesystem::path config_path = "configs/CloudnetHybridPipeline.json"; ///< 混合流水线配置文件路径
