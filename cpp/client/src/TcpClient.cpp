...
#include <cstring>
    ...
    constexpr int CloseError = SOCKET_ERROR;
...
TcpClient::TcpClient()
    : socket_(static_cast<int>(InvalidSocket)) {
}
...
void TcpClient::disconnect() {
    if (socket_ != static_cast<int>(InvalidSocket)) {
...
bool TcpClient::is_connected() const {
    return socket_ != static_cast<int>(InvalidSocket);
}
